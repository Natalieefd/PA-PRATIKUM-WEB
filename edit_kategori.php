<?php
   ...
   $kategori = mysqli_query($db, "SELECT * FROM kategori WHERE id_kategori = '".$_GET['id_kategori']."'");
            ...
            <div class="box">
                <form action="" method="POST" enctype = "multipart/form-data">
                    <table>
                        <tr>   
                            <td>Nama Kategori</td>
                            <td><input type="text" name="nama_kategori" placeholder="Nama Kategori" class="input_control" value="<?php echo $k->nama_kategori ?>" required></td>
                        </tr>
                        <tr>   
                        <br>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $update = mysqli_query($db, "UPDATE kategori SET nama_kategori='".$nama."' WHERE id_kategori='".$k->id_kategori."'");
